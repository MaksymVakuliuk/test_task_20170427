...
public class PostOfficeController {
    public static final String NO_POST_OFFICE_FOUND_DOR_ID = "No PostOffice found for ID %d";
    ...
    public ResponseEntity<?> getPostOffice(@PathVariable("id") long id) {
        ...
        if (postOfficeDto == null) {
            return new ResponseEntity<>(format(NO_POST_OFFICE_FOUND_DOR_ID, id), NOT_FOUND);
        }
